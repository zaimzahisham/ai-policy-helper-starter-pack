...
def test_openai_llm_with_mock(monkeypatch, client):
    ...
    class FakeOpenAI:
        def __init__(self, api_key, system_prompt_base: str | None = None, agent_guide: str | None = None, required_output_format: str | None = None):
    ...
    # Must match OpenAILLM.__init__ signature: (api_key, system_prompt_base, agent_guide, required_output_format)
    monkeypatch.setattr("app.rag.core.OpenAILLM", lambda api_key, system_prompt_base=None, agent_guide=None, required_output_format=None: FakeOpenAI(api_key, system_prompt_base, agent_guide, required_output_format))
